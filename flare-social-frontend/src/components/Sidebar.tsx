        ...
        <div className="mb-8">
          ...
          <div className="p-6 rounded-lg bg-[#2A3547] border border-[#3A4557]">
            <div className="flex items-center mb-6">
              ...
              <div>
                <div className="text-xl font-semibold">Sanjay Amirthraj</div>
                <div className="text-md text-gray-400">@sanjayamirthraj</div>
              </div>
            </div>
            <div className="text-md text-gray-300 mb-6">
              Building @flare | Prev: @CalBlockchain
            </div>
            ...
            <div className="flex flex-col space-y-2">
              <div className="bg-[#1E2A3B] rounded-lg p-4 flex justify-between items-center">
                ...
                <div className="text-xl font-semibold whitespace-nowrap">1,024</div>
              </div>
              <div className="bg-[#1E2A3B] rounded-lg p-4 flex justify-between items-center">
              ...
              <div className="bg-[#1E2A3B] rounded-lg p-4 flex justify-between items-center">
                ...
                <div className="text-xl font-semibold whitespace-nowrap">342</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 space-y-4">
            <button 
              className="flex items-center justify-center w-full px-6 py-4 rounded-lg text-white hover:bg-[#2A3547] transition-colors border border-[#3A4557] bg-[#2A3547]"
              onClick={onRefresh}
              disabled={isLoading}
            >
              ...
              {isLoading ? 'Refreshing Data...' : 'Refresh Profile Data'}
            </button>
